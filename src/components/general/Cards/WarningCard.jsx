  ...
  return (
    <StyledWarningBox>
      ...
      <Typography variant="body1" color="text.secondary">
        Ba&apos;zi holatlarda xaridor mahsulotni qaytaradi va mijozga mahsulot puli
        qaytarib beriladi. Shunday holatlarda tizim avtomatik tarzda admin
        hisobidan oldin qaytib kelgan mahsulot uchun to&apos;lab berilgan pulni
        yechib oladi. Hisobingizda mablag&apos; bo&apos;lmagan holatda hisobingiz manfiy
        balansga almashtiriladi.
      </Typography>
    </StyledWarningBox>
  );
};
